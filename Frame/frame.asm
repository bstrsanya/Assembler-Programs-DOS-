...
ReadComLine	
	...
	@@Continue:
		...
		cmp al, 0h			; if (al == 0) 
		jne @@Finish		; user style frame

		push cx

		xor cx, cx
		mov cx, 9h			; number of characters
		mov di, offset FrameStyle_0
							; addr to save characters
...
;---------------------------------------------
;	Program execution delay (DON'T USE)
;	Entry: Noun
;	Exit:  Noun
;	Destr: AH, CX, DX
;---------------------------------------------
